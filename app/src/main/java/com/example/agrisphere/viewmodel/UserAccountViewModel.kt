...
import com.example.agrisphere.AgriSphereApplication
...
class UserAccountViewModel @Inject constructor(
    ...
    private fun saveUserInformationWithNewImage(user: User, imageUri: Uri) {
        viewModelScope.launch {
            try {
                val imageBitmap = MediaStore.Images.Media.getBitmap(getApplication<AgriSphereApplication>().contentResolver, imageUri)
