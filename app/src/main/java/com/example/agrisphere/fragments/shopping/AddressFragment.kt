...
import com.example.agrisphere.databinding.FragmentAddressBinding
import com.example.agrisphere.util.Resource
import com.example.agrisphere.viewmodel.AddressViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (address == null){
            ...
            binding.apply {
                ...
                edStreet.setText(address.state)
